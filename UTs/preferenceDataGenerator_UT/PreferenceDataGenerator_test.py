...
action_pairs, preference_data = prefDataGenerator.GeneratePreferenceData(data=actions, limit=10)
...
action_pairs, preference_data = prefDataGenerator.GeneratePreferenceData(data=actions, limit=99)
...
assert(list(action_pairs.actions_pairs.shape)== [24, 2, actions.actions.shape[1]]) # 10 usual + 14 aditional pairs 
