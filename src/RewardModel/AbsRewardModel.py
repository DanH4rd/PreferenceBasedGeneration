...
class AbsRewardModel(object, metaclass=abc.ABCMeta):
    ...
    def GetStableRewards(self, data:AbsData) -> torch.Tensor:
        """
            ...
            Returns:
                [N] tensor containing N rewards
        """
        raise NotImplementedError('users must define GetStableRewards to use this base class')
    ...
    def SetToEvaluaionMode(self)  -> None:
        ...
        """
        raise NotImplementedError('users must define SetToEvaluaionMode to use this base class')
    ...
    def SetToTrainMode(self)  -> None:
        ...
        """
        raise NotImplementedError('users must define SetToTrainMode to use this base class')
    ...
    def IsTrainMode(self)  -> None:
        ...
        """
        raise NotImplementedError('users must define IsTrainMode to use this base class')
